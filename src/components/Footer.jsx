  ...
  return (
    <footer style={{ padding: "40px 32px 28px", borderTop: `1px solid ${P.steel}0a`, maxWidth: 1200, margin: "0 auto" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: 20 }}>
        <div>
          <div style={{ fontFamily: "'Courier New', monospace", fontSize: 9, letterSpacing: 4, color: P.bone, opacity: 0.1, textTransform: "uppercase", animation: "morphBreathSoft 12s ease-in-out infinite" }}>&copy; 2026 1RareGh0st &middot; All rights reserved</div>
